...
const Navbar = ({ userType }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 border-b border-gray-300 bg-white/90 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex items-center justify-between p-4">
