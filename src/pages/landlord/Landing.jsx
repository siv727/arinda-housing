      ...
      <div class = "flex flex-col">
                  ...
                  <div class = "grid grid-cols-1 md:grid-cols-2 gap-32 items-start">
                      <div class="flex flex-col gap-y-10">
                          ...
                          <p class="text-lg md:text-[20px] text-[#666666] max-w-3xl mx-auto">
                             Connect with verified students seeking quality housing. Our platform streamlines property management while maximizing your rental income through our trusted network.
                          </p>
          ...
          <section class = "flex flex-col items-center justify-center py-15 bg-[#FFFDFA] relative overflow-hidden">
                  ...
                  <div class = "md:text-6xl text-5xl text-[30px] font-bold text-[var(--text-title)] text-center leading-20 my-8">
                      Everything You Need to <span class = "bg-[#ffeae0] px-2 text-[#F35E27]">Succeed</span>
                  </div>
  
                  <div class =" md:text-[20px] text-center flex text-[#666666] ">Comprehensive tools and support to maximize your rental income and minimize vacancy periods</div>  
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-32 text-center my-10">
                              <div class="flex flex-col items-center w-64 gap-y-3">
                                  ...
                                  <div class="text-[20px] font-bold text-[#333333]">Verified Tenants</div>
                              ...
                              <div class="flex flex-col items-center w-64 gap-y-3">
                                  ...
                                  <div class="text-[20px] font-bold text-[#333333]">Smart Analytics</div>
                              ...
                              <div class="flex flex-col items-center w-64 gap-y-3">
                                  ...
                                  <div class="text-[20px] font-bold text-[#333333]">Community Insights</div>
                                  <div class="text-[14px] text-[#666666]">Access student reviews, neighborhood info, and popular amenities to make informed decisions and improve tenant satisfaction.</div>
                              </div>
                          </div>
          </section>
          ...
          <section class = "flex flex-col items-center justify-center py-20 bg-gradient-to-b from-[#FFFDFA] via-[#FFF1EB] to-[#FFFDFA] relative overflow-hidden">
              <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-10 relative z-20 "></div>    
                  ...
                  <div class =" max-w-[750px] md:text-[20px] text-center flex text-[#666666]">
                      Everything you need to list, manage, and rent out your properties efficiently and securely.
                  </div>
                  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-10 relative z-20 ">
          ...
          <section class = "flex flex-col items-center justify-center py-20 bg-gradient-to-t from-[#FFF1EB] to-[#FFFDFA] relative overflow-hidden">
                          ...
                          <div class = "md:text-6xl text-5xl text-[30px] font-bold text-[var(--text-title)] text-center leading-20 my-8">
                              All the tools you need to manage<br></br> your properties, <span class = "bg-[#ffeae0] px-2 text-[#F35E27]">all</span> in one app
                          </div>
          
                          <div class =" max-w-[750px] md:text-[20px] text-center flex text-[#666666] mb-10">Easily list, manage, and track your rental properties while maximizing income and minimizing vacancy—all in one place.</div>
                          ...
                          <div class="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-16 text-center">
                               <div class="flex flex-col items-center w-72">
                                  ...
                                  <div class="text-[20px] font-bold text-[#333333] mt-5">Landlord Panel</div>
                                  <div class="text-[14px] text-[#666666]">Easily manage all your properties in one place</div>
                                </div>
                                ...
                                <div class="flex flex-col items-center w-76 ">
                                  ...
                                  <div class="text-[20px] font-bold text-[#333333] mt-5">Current Rentals</div>
                                  <div class="text-[14px] text-[#666666]">Track occupancy, rental income, and lease details</div>
                                </div>
                                ...
                                <div class="flex flex-col items-center w-72 ">
                                  ...
                                  <div class="text-[20px] font-bold text-[#333333] mt-5">Messages</div>
                                  <div class="text-[14px] text-[#666666]">Communicate quickly with tenants and support</div>
                              </div>
                          </div>
                  </section>
