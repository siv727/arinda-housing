  ...
  return (
    <div className="pt-6 2xl:p-6 bg-[#FFFDFA] ">
      <div className="flex items-center justify-between mb-6  mx-auto ">
        ...
        <button onClick={() => navigate(-1)} className="text-sm px-6 py-2  text-[#222222] font-medium rounded-full  border border-[#DDDDDD] hover:bg-[#FFF8F2] cursor-pointer transition">
          Save & exit
        </button>
      </div>
