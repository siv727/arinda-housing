      ...
      <div class="flex flex-col">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-32 items-start">
              <div class="flex flex-col gap-y-10">
                ...
                <p class="text-lg md:text-[20px] text-[#666666] max-w-3xl mx-auto">
                  ...
                  affordable rentals designed specifically for students moving
                  to new cities.
                </p>
        ...
        <section class="relative ">
          ...
          <div class="relative mx-auto items-center justify-center flex flex-col text-center py-8">
            ...
            <div class=" max-w-[750px] text-center flex text-white md:text-[20px]">
        ...
        <section id = "about" class="flex flex-col items-center justify-center py-20 bg-[#FFFDFA] relative overflow-hidden">
          ...
          <div class="md:text-6xl text-5xl text-[30px] font-bold text-[var(--text-title)] text-center leading-20 my-8">
            Why Students Choose{" "}
            <span class="bg-[#ffeae0] px-2 text-[#F35E27]">Arinda</span>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-32 text-center">
            ...
            <div class="flex flex-col items-center w-64 gap-y-3">
              ...
              <div class="text-[14px] text-[#666666]">
                Message landlords directly, ask questions, and book securely
                with downloadable receipts for your records.
              </div>
            </div>
          </div>
        </section>
              ...
              <div class="flex flex-col gap-y-10">
                ...
                <div>
                  <ul class=" text-[#666666] space-y-4 text-[18px]">
                    <li>
                      <i class="fa-solid fa-badge-check pr-3 text-[#F35E27]"></i>{" "}
