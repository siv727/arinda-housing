...
export default function TypeStep({ form = {}, update }) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-lg text-gray-600 mb-7">Choose the type of property you want to list.</p>

      <div role="radiogroup" aria-label="Property type" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {TYPES.map((t) => (
          <TypeCard
            key={t.key}
            label={t.label}
