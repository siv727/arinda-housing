      ...
      <div className="p-6 pb-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mb-1">{application.propertyLocation}</p>
            <p className="text-sm text-gray-600">Landlord: {application.landlordName}</p>
          </div>
          <div className="flex flex-col items-end gap-2">
            <StatusBadge status={application.status} />
            <p className="text-lg font-bold text-gray-900">{application.propertyPrice}</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            {application.responseMessage && (
              <div>
                <label className="text-xs text-gray-500 font-semibold">Message from Landlord</label>
